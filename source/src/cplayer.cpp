...
cPlayer::cPlayer(char* tilesource, int spriteheight, int spritewidth) : cLevelObject(tilesource, spriteheight, spritewidth)
{
    // Init Variables
...
void cPlayer::fire()
{
    ...
    bullit = new cBullit("bullit.bmp",10,10,angle,10);
    cWorld::getInstance()->level->objects.push_back(bullit);    //Add to level object list
}
